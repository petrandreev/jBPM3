...
public class InitialNodeTest extends AbstractJbpmTestCase {
  ...
  public void testInitialNode() {
    ProcessDefinition processDefinition = ProcessDefinition.parseXmlString("<process-definition initial='first'>"
      + "  <state name='first'/>" + "</process-definition>");
  ...
  public void testInitialNodeExecution() {
    ProcessDefinition processDefinition = ProcessDefinition.parseXmlString("<process-definition initial='first'>"
      ...
      + "    <transition to='next'/>"
      + "  </node>"
      + "  <state name='next'>" + "  </state>" + "</process-definition>");

...
public class SuperStateTest extends AbstractJbpmTestCase {
  ...
  public void testSuperStateXmlParsing() {
    ProcessDefinition processDefinition = ProcessDefinition.parseXmlString("<process-definition>"
      ...
      + "    <node name='explosion' />"
      + "    <node name='cleanup' />"
      + "    <node name='repare' />" + "  </super-state>" + "</process-definition>");
  ...
  public void testNestedSuperStateXmlParsing() {
    ...
    assertEquals("take brush", processDefinition.findNode("phase one/cleanup/take brush")
      .getName());
  }
  ...
  public void testNestedSuperStateXmlTransitionParsing() {
    ...
    assertEquals("cleanup", preparation.getLeavingTransition("superstate-node")
      .getTo()
      .getName());
    assertEquals("take brush", preparation.getLeavingTransition("nested-superstate-node")
      .getTo()
      .getName());
    ...
    assertEquals("take brush", ignition.getLeavingTransition("superstate-node")
      .getTo()
      .getName());

    Node cleanup = processDefinition.findNode("phase one/cleanup/take brush");
    assertNotNull(ignition);
    assertEquals("preparation", cleanup.getLeavingTransition("recursive-parent")
      .getTo()
      .getName());
    ...
    assertEquals("phase one", cleanup.getLeavingTransition("absolute-superstate")
      .getTo()
      .getName());
  ...
  public void testSuperStateTransitionsParsing() {
    ...
    assertEquals("preparation", processDefinition.getNode("phase one")
      .getLeavingTransition("to-node")
      .getTo()
      .getName());
    assertEquals("phase one", processDefinition.getNode("phase one")
      .getLeavingTransition("self")
      .getTo()
      .getName());
    assertEquals("phase one", processDefinition.getNode("preparation")

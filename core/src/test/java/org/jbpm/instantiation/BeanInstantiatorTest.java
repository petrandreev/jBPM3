...
public class BeanInstantiatorTest extends AbstractJbpmTestCase {
  ...
  public void testBasicTypes() {
    String configuration = "<s>hello</s>" + "<stringConstructor>" + "  i want yoghurt"
      + "</stringConstructor>" + "<structuredElement>" + " <surfboard length=\"270\" />"
      + " <mast length=\"475\" />" + " <boom length=\"160\" />" + " <sail size=\"5.7\" />"
      + "</structuredElement>" + "<memberWithoutSetter>hello</memberWithoutSetter>";
  ...
  public void testInheritedSetterInjection() {
    String configuration = "<lineSize>5</lineSize>";

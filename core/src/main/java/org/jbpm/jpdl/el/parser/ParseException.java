...
public class ParseException extends Exception {
   ...
   */
  public ParseException(ELToken currentTokenVal, int[][] expectedTokenSequencesVal,
  ...
  /**
   * This is a reference to the "tokenImage" array of the generated parser within which the
   * parse error occurred. This array is defined in the generated ...Constants interface.
   */
